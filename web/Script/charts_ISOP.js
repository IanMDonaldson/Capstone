//view mean SWP scores of an Instructor over time
//requires user to select {instructor, range of term}
...
function ready() {
    var selectInstructor=document.getElementById("instructor")
