...
<body>
  <div class="topnav">
      ...
      <a  href="#page_name">Student Work Projects</a>
   <div class="topnav-right">
      <button class="btn"> <i class="fas fa-plus-circle"></i>Add SWP</button>
      <button class="btn"><i class="fas fa-edit"></i>Edit</button>
       ...
       <div class="dropdown">
        ...
        <div class="dropdown-content">
          ...
          <a href="#">course2</a>
          <a href="#">Course3</a>
          <button class="dropdown-btn-add">Add Course</button>
        </div>
      </div>
      <div class="dropdown">
        <button class="dropbtn">
        ...
        <div class="dropdown-content">
          ...
          <a href="#">year2</a>
          <a href="#">year3</a>
          <button class="dropdown-btn-add">Add Year</button>
        </div>
      </div>
