...
public class CourseDaoImpl implements CourseDao {
    ...
    public static void main(String[] args) {
        ...
        soList = courseDao.getCourseSORaw(1,1);
        for (StudentOutcome sos :
                soList) {
            System.out.println(sos.getSoID()+ " perf: " + sos.getPerformance());
        }
        String[] soNames = courseDao.SOnames(1,1);
        Float[][] list = courseDao.so2Array(soList,soNames);
