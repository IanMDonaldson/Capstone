...
public class works_onDaoImpl implements works_onDao {
    ...
    public boolean AddWorks_on(works_on works) {
        ...
        try{
            ...
            ps.setInt(1,works.getWorksOnid());
            ps.setInt(2,works.getFkWorksonStudent());
            ps.setInt(3,works.getFkWorksonSwp());
            ps.setInt(4,works.getFkWorksonTerm());
    ...
    public boolean updateWorks_on(works_on works) {
        ...
        try{
            ...
            ps.setInt(1,works.getWorksOnid());
            ps.setInt(2,works.getFkWorksonTerm());
            ps.setInt(3,works.getFkWorksonSwp());
            ps.setInt(4,works.getFkWorksonStudent());
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        }
        return false;
